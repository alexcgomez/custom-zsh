# Generated by Powerlevel10k configuration wizard on 2020-11-26 at 23:31 CET.
...
# vertical separators, blurred heads, blurred tails, 2 lines, disconnected, full frame,
...
() {
  ...
  ########################[ vpn_ip: virtual private network indicator ]#########################
  # VPN IP color.
  typeset -g POWERLEVEL9K_VPN_IP_FOREGROUND='#FFCD40'
